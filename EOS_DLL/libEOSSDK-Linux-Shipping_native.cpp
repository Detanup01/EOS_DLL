#include "libEOSSDK-Linux-Shipping_native.h"
...
{
    return _EOS_EpicAccountId_ToString(accountId, outBuffer, inOutBufferLength);
}
...
{
    return _EOS_ProductUserId_ToString(accountId, outBuffer, inOutBufferLength);
}
...
{
    _EOS_Connect_RemoveNotifyAuthExpiration(handle, inId);
}
...
{
    _EOS_Connect_RemoveNotifyLoginStatusChanged(handle, inId);
}
...
{
    return _EOS_Connect_CopyProductUserExternalAccountByAccountId(handle, options, outExternalAccountInfo);
}
...
{
    return _EOS_Connect_CopyProductUserExternalAccountByAccountType(handle, options, outExternalAccountInfo);
}
...
{
    return _EOS_Connect_CopyProductUserExternalAccountByIndex(handle, options, outExternalAccountInfo);
}
...
{
    return _EOS_Connect_CopyProductUserInfo(handle, options, outExternalAccountInfo);
}
    
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_ExternalAccountInfo_Release(intptr_t externalAccountInfo)
{
    _EOS_Connect_ExternalAccountInfo_Release(externalAccountInfo);
}
...
{
    _EOS_Connect_CreateDeviceId(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_DeleteDeviceId(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_QueryExternalAccountMappings(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_QueryProductUserIdMappings(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_LinkAccount(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_UnlinkAccount(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_CreateUser(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_Login(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_TransferDeviceIdAccount(handle, options, clientData, completionDelegate);
}
...
{
    _EOS_Connect_VerifyIdToken(handle, options, clientData, completionDelegate);
}
