...
//
// .NET Assembly: libEOSSDK-Linux-Shipping_cs
//

//
// Declare exported functions
//
#ifndef __DNNE_GENERATED_HEADER_LIBEOSSDK_LINUX_SHIPPING_CS__
#define __DNNE_GENERATED_HEADER_LIBEOSSDK_LINUX_SHIPPING_CS__
...
#endif // __DNNE_GENERATED_HEADER_LIBEOSSDK_LINUX_SHIPPING_CS__
...
#else
    static const char_t* t1_name = DNNE_STR("EOS_SDK._test.test_exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t2_name = DNNE_STR("EOS_SDK.Others.Common");
#else
    static const char_t* t2_name = DNNE_STR("EOS_SDK.Others.Common, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t3_name = DNNE_STR("EOS_SDK.Others.EpicAccountId");
#else
    static const char_t* t3_name = DNNE_STR("EOS_SDK.Others.EpicAccountId, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t4_name = DNNE_STR("EOS_SDK.Others.ProductUserId");
#else
    static const char_t* t4_name = DNNE_STR("EOS_SDK.Others.ProductUserId, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t5_name = DNNE_STR("EOS_SDK.Version.Version_Exports");
#else
    static const char_t* t5_name = DNNE_STR("EOS_SDK.Version.Version_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t6_name = DNNE_STR("EOS_SDK.Platform.Platform_Exports");
#else
    static const char_t* t6_name = DNNE_STR("EOS_SDK.Platform.Platform_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t7_name = DNNE_STR("EOS_SDK.Logging.Logging_Exports");
#else
    static const char_t* t7_name = DNNE_STR("EOS_SDK.Logging.Logging_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t8_name = DNNE_STR("EOS_SDK.Connect.Connect_Exports");
#else
    static const char_t* t8_name = DNNE_STR("EOS_SDK.Connect.Connect_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t9_name = DNNE_STR("EOS_SDK.Auth.Auth_Exports");
#else
    static const char_t* t9_name = DNNE_STR("EOS_SDK.Auth.Auth_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t10_name = DNNE_STR("EOS_SDK.AntiCheatServer.AntiCheatServer_Exports");
#else
    static const char_t* t10_name = DNNE_STR("EOS_SDK.AntiCheatServer.AntiCheatServer_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t11_name = DNNE_STR("EOS_SDK.AntiCheatClient.AntiCheatClient_Exports");
#else
    static const char_t* t11_name = DNNE_STR("EOS_SDK.AntiCheatClient.AntiCheatClient_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t12_name = DNNE_STR("EOS_SDK.ActiveSession.ActiveSession_Exports");
#else
    static const char_t* t12_name = DNNE_STR("EOS_SDK.ActiveSession.ActiveSession_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t13_name = DNNE_STR("EOS_SDK.Achievements.Achievements_Exports");
#else
    static const char_t* t13_name = DNNE_STR("EOS_SDK.Achievements.Achievements_Exports, libEOSSDK-Linux-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK
