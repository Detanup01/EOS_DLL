...
#pragma comment(lib, "EOSSDK-Win64-Shipping_native")

//
// Auto-generated by dnne-gen
//
// .NET Assembly: EOSSDK-Win64-Shipping_cs
//

//
// Declare exported functions
//
#ifndef __DNNE_GENERATED_HEADER_EOSSDK_WIN64_SHIPPING_CS__
#define __DNNE_GENERATED_HEADER_EOSSDK_WIN64_SHIPPING_CS__
...
// Computed from EOS_SDK.Others.EpicAccountId.EOS_EpicAccountId_FromString
DNNE_EXTERN_C DNNE_API intptr_t DNNE_CALLTYPE_STDCALL EOS_EpicAccountId_FromString(intptr_t accountIdString);

// Computed from EOS_SDK.Others.EpicAccountId.EOS_EpicAccountId_IsValid
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_EpicAccountId_IsValid(intptr_t accountId);

// Computed from EOS_SDK.Others.EpicAccountId.EOS_EpicAccountId_ToString
...
// Computed from EOS_SDK.Others.ProductUserId.EOS_ProductUserId_FromString
DNNE_EXTERN_C DNNE_API intptr_t DNNE_CALLTYPE_STDCALL EOS_ProductUserId_FromString(intptr_t productUserIdString);

// Computed from EOS_SDK.Others.ProductUserId.EOS_ProductUserId_IsValid
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_ProductUserId_IsValid(intptr_t accountId);

// Computed from EOS_SDK.Others.ProductUserId.EOS_ProductUserId_ToString
...
// Computed from EOS_SDK.Logging.Logging_Exports.EOS_Logging_SetCallback
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Logging_SetCallback(intptr_t callback);

// Computed from EOS_SDK.Logging.Logging_Exports.EOS_Logging_SetLogLevel
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Logging_SetLogLevel(int32_t logCategory, int32_t logLevel);

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_AddNotifyAuthExpiration
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_RemoveNotifyAuthExpiration
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_RemoveNotifyAuthExpiration(intptr_t handle, uint64_t inId);

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_AddNotifyLoginStatusChanged
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_RemoveNotifyLoginStatusChanged
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyIdToken
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_IdToken_Release
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_IdToken_Release(intptr_t idToken);

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserExternalAccountByAccountId
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserExternalAccountByAccountType
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserExternalAccountByIndex
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserInfo
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_ExternalAccountInfo_Release
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_ExternalAccountInfo_Release(intptr_t externalAccountInfo);

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CreateDeviceId
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_DeleteDeviceId
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetExternalAccountMapping
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetProductUserIdMapping
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_QueryExternalAccountMappings
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_QueryProductUserIdMappings
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_LinkAccount
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_UnlinkAccount
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CreateUser
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_Login
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_TransferDeviceIdAccount
...
// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_VerifyIdToken
...
#endif // __DNNE_GENERATED_HEADER_EOSSDK_WIN64_SHIPPING_CS__
...
#else
    static const char_t* t1_name = DNNE_STR("EOS_SDK._test.test_exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t2_name = DNNE_STR("EOS_SDK.Others.Common");
#else
    static const char_t* t2_name = DNNE_STR("EOS_SDK.Others.Common, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t3_name = DNNE_STR("EOS_SDK.Others.EpicAccountId");
#else
    static const char_t* t3_name = DNNE_STR("EOS_SDK.Others.EpicAccountId, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t4_name = DNNE_STR("EOS_SDK.Others.ProductUserId");
#else
    static const char_t* t4_name = DNNE_STR("EOS_SDK.Others.ProductUserId, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t5_name = DNNE_STR("EOS_SDK.Version.Version_Exports");
#else
    static const char_t* t5_name = DNNE_STR("EOS_SDK.Version.Version_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t6_name = DNNE_STR("EOS_SDK.Platform.Platform_Exports");
#else
    static const char_t* t6_name = DNNE_STR("EOS_SDK.Platform.Platform_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t7_name = DNNE_STR("EOS_SDK.Logging.Logging_Exports");
#else
    static const char_t* t7_name = DNNE_STR("EOS_SDK.Logging.Logging_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t8_name = DNNE_STR("EOS_SDK.Connect.Connect_Exports");
#else
    static const char_t* t8_name = DNNE_STR("EOS_SDK.Connect.Connect_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t9_name = DNNE_STR("EOS_SDK.Auth.Auth_Exports");
#else
    static const char_t* t9_name = DNNE_STR("EOS_SDK.Auth.Auth_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t10_name = DNNE_STR("EOS_SDK.AntiCheatServer.AntiCheatServer_Exports");
#else
    static const char_t* t10_name = DNNE_STR("EOS_SDK.AntiCheatServer.AntiCheatServer_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t11_name = DNNE_STR("EOS_SDK.AntiCheatClient.AntiCheatClient_Exports");
#else
    static const char_t* t11_name = DNNE_STR("EOS_SDK.AntiCheatClient.AntiCheatClient_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t12_name = DNNE_STR("EOS_SDK.ActiveSession.ActiveSession_Exports");
#else
    static const char_t* t12_name = DNNE_STR("EOS_SDK.ActiveSession.ActiveSession_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK

#ifdef DNNE_TARGET_NET_FRAMEWORK
    static const char_t* t13_name = DNNE_STR("EOS_SDK.Achievements.Achievements_Exports");
#else
    static const char_t* t13_name = DNNE_STR("EOS_SDK.Achievements.Achievements_Exports, EOSSDK-Win64-Shipping_cs");
#endif // !DNNE_TARGET_NET_FRAMEWORK
...
// Computed from EOS_SDK.Others.EpicAccountId.EOS_EpicAccountId_FromString
static intptr_t (DNNE_CALLTYPE_STDCALL* EOS_EpicAccountId_FromString_ptr)(intptr_t accountIdString);
DNNE_EXTERN_C DNNE_API intptr_t DNNE_CALLTYPE_STDCALL EOS_EpicAccountId_FromString(intptr_t accountIdString)
{
    if (EOS_EpicAccountId_FromString_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_EpicAccountId_FromString");
        EOS_EpicAccountId_FromString_ptr = (intptr_t(DNNE_CALLTYPE_STDCALL*)(intptr_t accountIdString))get_fast_callable_managed_function(t3_name, methodName);
    }
    return EOS_EpicAccountId_FromString_ptr(accountIdString);
}

// Computed from EOS_SDK.Others.EpicAccountId.EOS_EpicAccountId_IsValid
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_EpicAccountId_IsValid_ptr)(intptr_t accountId);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_EpicAccountId_IsValid(intptr_t accountId)
{
    if (EOS_EpicAccountId_IsValid_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_EpicAccountId_IsValid");
        EOS_EpicAccountId_IsValid_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t accountId))get_fast_callable_managed_function(t3_name, methodName);
    }
    return EOS_EpicAccountId_IsValid_ptr(accountId);
}

// Computed from EOS_SDK.Others.EpicAccountId.EOS_EpicAccountId_ToString
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_EpicAccountId_ToString_ptr)(intptr_t accountId, intptr_t outBuffer, int32_t inOutBufferLength);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_EpicAccountId_ToString(intptr_t accountId, intptr_t outBuffer, int32_t inOutBufferLength)
{
    if (EOS_EpicAccountId_ToString_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_EpicAccountId_ToString");
        EOS_EpicAccountId_ToString_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t accountId, intptr_t outBuffer, int32_t inOutBufferLength))get_fast_callable_managed_function(t3_name, methodName);
    }
    return EOS_EpicAccountId_ToString_ptr(accountId, outBuffer, inOutBufferLength);
}

// Computed from EOS_SDK.Others.ProductUserId.EOS_ProductUserId_FromString
static intptr_t (DNNE_CALLTYPE_STDCALL* EOS_ProductUserId_FromString_ptr)(intptr_t productUserIdString);
DNNE_EXTERN_C DNNE_API intptr_t DNNE_CALLTYPE_STDCALL EOS_ProductUserId_FromString(intptr_t productUserIdString)
{
    if (EOS_ProductUserId_FromString_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_ProductUserId_FromString");
        EOS_ProductUserId_FromString_ptr = (intptr_t(DNNE_CALLTYPE_STDCALL*)(intptr_t productUserIdString))get_fast_callable_managed_function(t4_name, methodName);
    }
    return EOS_ProductUserId_FromString_ptr(productUserIdString);
}

// Computed from EOS_SDK.Others.ProductUserId.EOS_ProductUserId_IsValid
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_ProductUserId_IsValid_ptr)(intptr_t accountId);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_ProductUserId_IsValid(intptr_t accountId)
{
    if (EOS_ProductUserId_IsValid_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_ProductUserId_IsValid");
        EOS_ProductUserId_IsValid_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t accountId))get_fast_callable_managed_function(t4_name, methodName);
    }
    return EOS_ProductUserId_IsValid_ptr(accountId);
}

// Computed from EOS_SDK.Others.ProductUserId.EOS_ProductUserId_ToString
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_ProductUserId_ToString_ptr)(intptr_t accountId, intptr_t outBuffer, int32_t inOutBufferLength);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_ProductUserId_ToString(intptr_t accountId, intptr_t outBuffer, int32_t inOutBufferLength)
{
    if (EOS_ProductUserId_ToString_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_ProductUserId_ToString");
        EOS_ProductUserId_ToString_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t accountId, intptr_t outBuffer, int32_t inOutBufferLength))get_fast_callable_managed_function(t4_name, methodName);
    }
    return EOS_ProductUserId_ToString_ptr(accountId, outBuffer, inOutBufferLength);
}
...
// Computed from EOS_SDK.Logging.Logging_Exports.EOS_Logging_SetCallback
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Logging_SetCallback_ptr)(intptr_t callback);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Logging_SetCallback(intptr_t callback)
{
    if (EOS_Logging_SetCallback_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Logging_SetCallback");
        EOS_Logging_SetCallback_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t callback))get_fast_callable_managed_function(t7_name, methodName);
    }
    return EOS_Logging_SetCallback_ptr(callback);
}

// Computed from EOS_SDK.Logging.Logging_Exports.EOS_Logging_SetLogLevel
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Logging_SetLogLevel_ptr)(int32_t logCategory, int32_t logLevel);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Logging_SetLogLevel(int32_t logCategory, int32_t logLevel)
{
    if (EOS_Logging_SetLogLevel_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Logging_SetLogLevel");
        EOS_Logging_SetLogLevel_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(int32_t logCategory, int32_t logLevel))get_fast_callable_managed_function(t7_name, methodName);
    }
    return EOS_Logging_SetLogLevel_ptr(logCategory, logLevel);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_AddNotifyAuthExpiration
static uint64_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_AddNotifyAuthExpiration_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t notification);
DNNE_EXTERN_C DNNE_API uint64_t DNNE_CALLTYPE_STDCALL EOS_Connect_AddNotifyAuthExpiration(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t notification)
{
    if (EOS_Connect_AddNotifyAuthExpiration_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_AddNotifyAuthExpiration");
        EOS_Connect_AddNotifyAuthExpiration_ptr = (uint64_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t notification))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_AddNotifyAuthExpiration_ptr(handle, options, clientData, notification);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_RemoveNotifyAuthExpiration
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_RemoveNotifyAuthExpiration_ptr)(intptr_t handle, uint64_t inId);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_RemoveNotifyAuthExpiration(intptr_t handle, uint64_t inId)
{
    if (EOS_Connect_RemoveNotifyAuthExpiration_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_RemoveNotifyAuthExpiration");
        EOS_Connect_RemoveNotifyAuthExpiration_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, uint64_t inId))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_RemoveNotifyAuthExpiration_ptr(handle, inId);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_AddNotifyLoginStatusChanged
static uint64_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_AddNotifyLoginStatusChanged_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t notification);
DNNE_EXTERN_C DNNE_API uint64_t DNNE_CALLTYPE_STDCALL EOS_Connect_AddNotifyLoginStatusChanged(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t notification)
{
    if (EOS_Connect_AddNotifyLoginStatusChanged_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_AddNotifyLoginStatusChanged");
        EOS_Connect_AddNotifyLoginStatusChanged_ptr = (uint64_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t notification))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_AddNotifyLoginStatusChanged_ptr(handle, options, clientData, notification);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_RemoveNotifyLoginStatusChanged
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_RemoveNotifyLoginStatusChanged_ptr)(intptr_t handle, uint64_t inId);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_RemoveNotifyLoginStatusChanged(intptr_t handle, uint64_t inId)
{
    if (EOS_Connect_RemoveNotifyLoginStatusChanged_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_RemoveNotifyLoginStatusChanged");
        EOS_Connect_RemoveNotifyLoginStatusChanged_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, uint64_t inId))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_RemoveNotifyLoginStatusChanged_ptr(handle, inId);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyIdToken
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_CopyIdToken_ptr)(intptr_t handle, intptr_t options, intptr_t outIdToken);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_CopyIdToken(intptr_t handle, intptr_t options, intptr_t outIdToken)
{
    if (EOS_Connect_CopyIdToken_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CopyIdToken");
        EOS_Connect_CopyIdToken_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t outIdToken))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_CopyIdToken_ptr(handle, options, outIdToken);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_IdToken_Release
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_IdToken_Release_ptr)(intptr_t idToken);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_IdToken_Release(intptr_t idToken)
{
    if (EOS_Connect_IdToken_Release_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_IdToken_Release");
        EOS_Connect_IdToken_Release_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t idToken))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_IdToken_Release_ptr(idToken);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserExternalAccountByAccountId
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_CopyProductUserExternalAccountByAccountId_ptr)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_CopyProductUserExternalAccountByAccountId(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo)
{
    if (EOS_Connect_CopyProductUserExternalAccountByAccountId_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CopyProductUserExternalAccountByAccountId");
        EOS_Connect_CopyProductUserExternalAccountByAccountId_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_CopyProductUserExternalAccountByAccountId_ptr(handle, options, outExternalAccountInfo);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserExternalAccountByAccountType
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_CopyProductUserExternalAccountByAccountType_ptr)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_CopyProductUserExternalAccountByAccountType(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo)
{
    if (EOS_Connect_CopyProductUserExternalAccountByAccountType_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CopyProductUserExternalAccountByAccountType");
        EOS_Connect_CopyProductUserExternalAccountByAccountType_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_CopyProductUserExternalAccountByAccountType_ptr(handle, options, outExternalAccountInfo);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserExternalAccountByIndex
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_CopyProductUserExternalAccountByIndex_ptr)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_CopyProductUserExternalAccountByIndex(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo)
{
    if (EOS_Connect_CopyProductUserExternalAccountByIndex_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CopyProductUserExternalAccountByIndex");
        EOS_Connect_CopyProductUserExternalAccountByIndex_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_CopyProductUserExternalAccountByIndex_ptr(handle, options, outExternalAccountInfo);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CopyProductUserInfo
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_CopyProductUserInfo_ptr)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_CopyProductUserInfo(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo)
{
    if (EOS_Connect_CopyProductUserInfo_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CopyProductUserInfo");
        EOS_Connect_CopyProductUserInfo_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t outExternalAccountInfo))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_CopyProductUserInfo_ptr(handle, options, outExternalAccountInfo);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_ExternalAccountInfo_Release
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_ExternalAccountInfo_Release_ptr)(intptr_t externalAccountInfo);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_ExternalAccountInfo_Release(intptr_t externalAccountInfo)
{
    if (EOS_Connect_ExternalAccountInfo_Release_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_ExternalAccountInfo_Release");
        EOS_Connect_ExternalAccountInfo_Release_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t externalAccountInfo))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_ExternalAccountInfo_Release_ptr(externalAccountInfo);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CreateDeviceId
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_CreateDeviceId_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_CreateDeviceId(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_CreateDeviceId_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CreateDeviceId");
        EOS_Connect_CreateDeviceId_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_CreateDeviceId_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_DeleteDeviceId
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_DeleteDeviceId_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_DeleteDeviceId(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_DeleteDeviceId_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_DeleteDeviceId");
        EOS_Connect_DeleteDeviceId_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_DeleteDeviceId_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetExternalAccountMapping
static intptr_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_GetExternalAccountMapping_ptr)(intptr_t handle, intptr_t options);
DNNE_EXTERN_C DNNE_API intptr_t DNNE_CALLTYPE_STDCALL EOS_Connect_GetExternalAccountMapping(intptr_t handle, intptr_t options)
{
    if (EOS_Connect_GetExternalAccountMapping_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_GetExternalAccountMapping");
        EOS_Connect_GetExternalAccountMapping_ptr = (intptr_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_GetExternalAccountMapping_ptr(handle, options);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetLoggedInUserByIndex
static intptr_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_GetLoggedInUserByIndex_ptr)(intptr_t handle, int32_t index);
DNNE_EXTERN_C DNNE_API intptr_t DNNE_CALLTYPE_STDCALL EOS_Connect_GetLoggedInUserByIndex(intptr_t handle, int32_t index)
{
    if (EOS_Connect_GetLoggedInUserByIndex_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_GetLoggedInUserByIndex");
        EOS_Connect_GetLoggedInUserByIndex_ptr = (intptr_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, int32_t index))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_GetLoggedInUserByIndex_ptr(handle, index);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetLoggedInUsersCount
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_GetLoggedInUsersCount_ptr)(intptr_t handle);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_GetLoggedInUsersCount(intptr_t handle)
{
    if (EOS_Connect_GetLoggedInUsersCount_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_GetLoggedInUsersCount");
        EOS_Connect_GetLoggedInUsersCount_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_GetLoggedInUsersCount_ptr(handle);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetLoginStatus
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_GetLoginStatus_ptr)(intptr_t handle, intptr_t localUserId);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_GetLoginStatus(intptr_t handle, intptr_t localUserId)
{
    if (EOS_Connect_GetLoginStatus_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_GetLoginStatus");
        EOS_Connect_GetLoginStatus_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t localUserId))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_GetLoginStatus_ptr(handle, localUserId);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetProductUserExternalAccountCount
static uint32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_GetProductUserExternalAccountCount_ptr)(intptr_t handle, intptr_t options);
DNNE_EXTERN_C DNNE_API uint32_t DNNE_CALLTYPE_STDCALL EOS_Connect_GetProductUserExternalAccountCount(intptr_t handle, intptr_t options)
{
    if (EOS_Connect_GetProductUserExternalAccountCount_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_GetProductUserExternalAccountCount");
        EOS_Connect_GetProductUserExternalAccountCount_ptr = (uint32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_GetProductUserExternalAccountCount_ptr(handle, options);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_GetProductUserIdMapping
static int32_t (DNNE_CALLTYPE_STDCALL* EOS_Connect_GetProductUserIdMapping_ptr)(intptr_t handle, intptr_t options, intptr_t outBuffer, int32_t inOutBufferLength);
DNNE_EXTERN_C DNNE_API int32_t DNNE_CALLTYPE_STDCALL EOS_Connect_GetProductUserIdMapping(intptr_t handle, intptr_t options, intptr_t outBuffer, int32_t inOutBufferLength)
{
    if (EOS_Connect_GetProductUserIdMapping_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_GetProductUserIdMapping");
        EOS_Connect_GetProductUserIdMapping_ptr = (int32_t(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t outBuffer, int32_t inOutBufferLength))get_fast_callable_managed_function(t8_name, methodName);
    }
    return EOS_Connect_GetProductUserIdMapping_ptr(handle, options, outBuffer, inOutBufferLength);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_QueryExternalAccountMappings
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_QueryExternalAccountMappings_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_QueryExternalAccountMappings(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_QueryExternalAccountMappings_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_QueryExternalAccountMappings");
        EOS_Connect_QueryExternalAccountMappings_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_QueryExternalAccountMappings_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_QueryProductUserIdMappings
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_QueryProductUserIdMappings_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_QueryProductUserIdMappings(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_QueryProductUserIdMappings_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_QueryProductUserIdMappings");
        EOS_Connect_QueryProductUserIdMappings_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_QueryProductUserIdMappings_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_LinkAccount
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_LinkAccount_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_LinkAccount(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_LinkAccount_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_LinkAccount");
        EOS_Connect_LinkAccount_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_LinkAccount_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_UnlinkAccount
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_UnlinkAccount_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_UnlinkAccount(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_UnlinkAccount_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_UnlinkAccount");
        EOS_Connect_UnlinkAccount_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_UnlinkAccount_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_CreateUser
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_CreateUser_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_CreateUser(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_CreateUser_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_CreateUser");
        EOS_Connect_CreateUser_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_CreateUser_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_Login
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_Login_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_Login(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_Login_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_Login");
        EOS_Connect_Login_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_Login_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_TransferDeviceIdAccount
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_TransferDeviceIdAccount_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_TransferDeviceIdAccount(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_TransferDeviceIdAccount_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_TransferDeviceIdAccount");
        EOS_Connect_TransferDeviceIdAccount_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_TransferDeviceIdAccount_ptr(handle, options, clientData, completionDelegate);
}

// Computed from EOS_SDK.Connect.Connect_Exports.EOS_Connect_VerifyIdToken
static void (DNNE_CALLTYPE_STDCALL* EOS_Connect_VerifyIdToken_ptr)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate);
DNNE_EXTERN_C DNNE_API void DNNE_CALLTYPE_STDCALL EOS_Connect_VerifyIdToken(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate)
{
    if (EOS_Connect_VerifyIdToken_ptr == NULL)
    {
        const char_t* methodName = DNNE_STR("EOS_Connect_VerifyIdToken");
        EOS_Connect_VerifyIdToken_ptr = (void(DNNE_CALLTYPE_STDCALL*)(intptr_t handle, intptr_t options, intptr_t clientData, intptr_t completionDelegate))get_fast_callable_managed_function(t8_name, methodName);
    }
    EOS_Connect_VerifyIdToken_ptr(handle, options, clientData, completionDelegate);
}
