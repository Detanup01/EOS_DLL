...
namespace EOS_SDK.Platform
{
    public unsafe class Platform_Exports
    {
        ...
        [UnmanagedCallersOnly(CallConvs = new[] { typeof(CallConvCdecl), typeof(CallConvStdcall) })]
        public static Result EOS_Platform_GetDesktopCrossplayStatus(IntPtr handle, IntPtr options, IntPtr Platform.DesktopCrossplayStatusInfo outDesktopCrossplayStatusInfo)
		{
			var _GetDesktopCrossplayStatusOptions = Marshal.PtrToStructure<GetDesktopCrossplayStatusOptions>(options);
			delegate* unmanaged[Cdecl, Stdcall]<IntPtr, void> @delegate = (delegate* unmanaged[Cdecl, Stdcall]<IntPtr, void>)Platform.DesktopCrossplayStatusInfo; //Delegate Class was: [Out]
        }
