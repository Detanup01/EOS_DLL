...
namespace EOS_SDK
{
    ...
    public enum ExternalCredentialType : int
	{
		...
		/// 
		/// Using ID Token is preferred, retrieved with <see cref="Auth.AuthInterface.CopyIdToken" /> that returns <see cref="IdToken.JsonWebToken" />.
		/// Using Auth Token is supported for backwards compatibility, retrieved with <see cref="Auth.AuthInterface.CopyUserAuthToken" /> that returns <see cref="Token.AccessToken" />.
		/// 
		...
		/// Epic Games ID Token
		/// 
		/// Acquired using <see cref="Auth.AuthInterface.CopyIdToken" /> that returns <see cref="IdToken.JsonWebToken" />.
		/// 
		/// Supported with <see cref="Connect.ConnectInterface.Login" />.
		/// </summary>
		EpicIdToken = 16,
